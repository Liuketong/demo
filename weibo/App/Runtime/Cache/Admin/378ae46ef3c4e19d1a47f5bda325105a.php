...
<div id="user_tool" style="padding:5px;">
	<div style="margin-bottom:5px;">
		...
		<a href="javascript:void(0)" class="easyui-linkbutton" plain="true" iconCls="icon-delete-new" onclick="javascript:alert('避免乱删，被禁用！');">删除</a>
...
<form id="user_add" style="margin:0;padding:5px 0 0 25px;color:#333;">
	...
	<p><span style="vertical-align:37px;">默认头像：</span><img src="/weibo/Public/Admin/img/small_face.jpg" alt="默认头像" style="cursor:pointer;" onclick="javascript:alert('和前台裁剪图片一样，可以使用点击弹出dialog再上传头像')"></p>
