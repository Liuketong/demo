...
<div id="main">
			...
			<?php if(is_array($topicList)): $i = 0; $__LIST__ = $topicList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$obj): $mod = ($i % 2 );++$i; if(empty($obj["reid"])): ?><dl class="weibo_content_data">
				...
				<dd>
					...
					<?php switch($obj["count"]): case "0": break;?>
						...
						<?php default: ?>
							<?php $__FOR_START_32055__=0;$__FOR_END_32055__=$obj['count'];for($i=$__FOR_START_32055__;$i < $__FOR_END_32055__;$i+=1){ ?><div class="imgs"><img src="/weibo/<?php echo ($obj['images'][$i]['thumb']); ?>" unfold-src="/weibo/<?php echo ($obj['images'][$i]['unfold']); ?>" source-src="/weibo/<?php echo ($obj['images'][$i]['source']); ?>" alt=""></div><?php } endswitch;?>
					<div class="footer">
				...
				<dd>
					...
					<div class="re_content" style="overflow:auto;">
						...
						<?php switch($obj["recontent"]["count"]): case "0": break;?>
							...
							<?php default: ?>
								<?php $__FOR_START_17060__=0;$__FOR_END_17060__=$obj['recontent']['count'];for($i=$__FOR_START_17060__;$i < $__FOR_END_17060__;$i+=1){ ?><div class="imgs"><img src="/weibo/<?php echo ($obj['recontent']['images'][$i]['thumb']); ?>" unfold-src="/weibo/<?php echo ($obj['recontent']['images'][$i]['unfold']); ?>" source-src="/weibo/<?php echo ($obj['recontent']['images'][$i]['source']); ?>" alt=""></div><?php } endswitch;?>
						<div class="footer">
				...
				<dl class="weibo_content_data">
					...
					<dd>
						...
						<div class="img_zoom" style="display:none">
							...
							<img data="#放大图#" src="/weibo/Public/Home/img/loading_100.png" alt="">
						</div>
						<div class="footer">
							<span class="time">刚刚发布</span>
							<span class="handler">赞(0) | 转播 | 评论 | 收藏</span>
	...
	<div class="main_right">
		...
		<?php else: ?>
			<img src="/weibo<?php echo (substr($bigFace,1)); ?>" alt="" class="face"><?php endif; ?>
		<span class="user">
